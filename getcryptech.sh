...
#
rm -rf hsm-software/sw/hsm_tools/cryptech
mkdir -p hsm-software/sw/hsm_tools/cryptech/cryptech
...
echo 'DO NOT add or modify files or sub-folders in this folder. This folder contains unmodified Cryptech code that is automatically pulled from Cryptech. Any changes will be overwritten.' > hsm-software/sw/hsm_tools/cryptech/X_DO_NOT_MODIFY_FOLDER_X.txt
echo 'Copy Complete'