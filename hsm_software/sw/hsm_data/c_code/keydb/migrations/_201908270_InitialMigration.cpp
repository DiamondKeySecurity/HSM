...
( \
  ...
  CKA_SERIAL_NUMBER     VARBINARY(256)   DEFAULT NULL, \
  CKA_OWNER             VARBINARY(256)   DEFAULT NULL, \
  CKA_ATTR_TYPES        VARBINARY(256)   DEFAULT NULL, \
  CKA_TRUSTED           BOOLEAN         DEFAULT TRUE, \
  CKA_KEY_TYPE          INT             DEFAULT 0, \
  CKA_SUBJECT           VARBINARY(256)   DEFAULT NULL, \
  CKA_ID                VARBINARY(256)  DEFAULT NULL, \
  ...
  CKA_MODULUS           VARBINARY(256)   DEFAULT NULL, \
  CKA_MODULUS_BITS      VARBINARY(256)   DEFAULT NULL, \
  CKA_PUBLIC_EXPONENT   VARBINARY(256)   DEFAULT NULL, \
  CKA_EXTRACTABLE       BOOLEAN         DEFAULT FALSE, \
  CKA_MODIFIABLE        BOOLEAN         DEFAULT TRUE, \
  CKA_WRAP_WITH_TRUSTED BOOLEAN         DEFAULT FALSE, \
  CKA_EC_PARAMS         VARBINARY(256)  DEFAULT NULL, \
  CKA_EC_POINT          VARBINARY(256)  DEFAULT NULL, \
  PRIMARY KEY (id) \
);";
