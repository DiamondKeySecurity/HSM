...
( \
  ...
  CKA_SERIAL_NUMBER     VARBINARY(64)   DEFAULT NULL, \
  CKA_OWNER             VARBINARY(64)   DEFAULT NULL, \
  CKA_ATTR_TYPES        VARBINARY(64)   DEFAULT NULL, \
  CKA_TRUSTED           BOOLEAN         DEFAULT TRUE, \
  CKA_KEY_TYPE          INT             DEFAULT 0, \
  CKA_SUBJECT           VARBINARY(64)   DEFAULT NULL, \
  ...
  CKA_MODULUS           VARBINARY(32)   DEFAULT NULL, \
  CKA_MODULUS_BITS      VARBINARY(64)   DEFAULT NULL, \
  CKA_PUBLIC_EXPONENT   VARBINARY(64)   DEFAULT NULL, \
